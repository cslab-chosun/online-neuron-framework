...
```sh
git clone git@github.com:cslab-chosun/online-neuron-framework.git
cd online-neuron-framework
```
...
#### Commit your changes
```sh
git commit -m 'Starting online-neuron-framework'
...
```sh
mill online-neuron-framework.test
```
